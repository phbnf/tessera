...
func FetchCheckpoint(ctx context.Context, f CheckpointFetcherFunc, v note.Verifier, origin string) (*log.Checkpoint, []byte, *note.Note, error) {
	return otel.Trace3(ctx, "tessera.client.FetchCheckpoint", tracer, func(ctx context.Context, span trace.Span) (*log.Checkpoint, []byte, *note.Note, error) {
		cpRaw, err := f(ctx)
		if err != nil {
...
func FetchRangeNodes(ctx context.Context, s uint64, f TileFetcherFunc) ([][]byte, error) {
	return otel.Trace(ctx, "tessera.client.FetchRangeNodes", tracer, func(ctx context.Context, span trace.Span) ([][]byte, error) {
...
func FetchLeafHashes(ctx context.Context, f TileFetcherFunc, first, N, logSize uint64) ([][]byte, error) {
	return otel.Trace(ctx, "tessera.client.FetchLeafHashes", tracer, func(ctx context.Context, span trace.Span) ([][]byte, error) {
...
func GetEntryBundle(ctx context.Context, f EntryBundleFetcherFunc, i, logSize uint64) (api.EntryBundle, error) {
	return otel.Trace(ctx, "tessera.client.GetEntryBundle", tracer, func(ctx context.Context, span trace.Span) (api.EntryBundle, error) {
...
func (pb *ProofBuilder) InclusionProof(ctx context.Context, index uint64) ([][]byte, error) {
	return otel.Trace(ctx, "tessera.client.InclusionProof", tracer, func(ctx context.Context, span trace.Span) ([][]byte, error) {
...
func (pb *ProofBuilder) ConsistencyProof(ctx context.Context, smaller, larger uint64) ([][]byte, error) {
	return otel.Trace(ctx, "tessera.client.ConsistencyProof", tracer, func(ctx context.Context, span trace.Span) ([][]byte, error) {
...
// SubtreeInclusionProof constructs a subtree inclusion proof for index the specified range [start, end).
...
func (lst *LogStateTracker) Update(ctx context.Context) ([]byte, [][]byte, []byte, error) {
	return otel.Trace3(ctx, "tessera.client.logstatetracker.Update", tracer, func(ctx context.Context, span trace.Span) ([]byte, [][]byte, []byte, error) {
